...
function PerfCard({label,perf}){
  ...
  return <div style={{padding:"13px 10px",borderRadius:17,background:"#fff6fb",border:"1px solid #f3d2e4",textAlign:"center"}}>
    <span style={{fontSize:12,fontWeight:900,color:"#c43d7b"}}>{label} イン崩れ率</span>
    <strong style={{display:"block",marginTop:3,fontSize:28,color:"#d62f7c"}}>{perf.hitRate==null?"—%":`${perf.hitRate.toFixed(1)}%`}</strong>
