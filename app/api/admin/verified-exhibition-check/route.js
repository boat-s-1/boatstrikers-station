...
export async function GET(request) {
  ...
  // Fixed verified venue only; no arbitrary URL, credentials, DB, or notifications.
  if (!validMarugameRace(race)) return reply({ ok:false, error:'invalid_or_unverified_venue' },400);
