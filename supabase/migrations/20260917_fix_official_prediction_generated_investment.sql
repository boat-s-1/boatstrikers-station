-- Keep bsc_official_predictions.investment as the generated source of truth.
-- This migration only removes the obsolete explicit investment value from the
-- AI prediction freeze trigger function. It does not backfill historical rows.
