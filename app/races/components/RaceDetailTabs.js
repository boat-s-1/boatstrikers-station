...
function IchikaLivePanel({ prediction, previousPrediction, entries, event, noteFeature }) {
  ...
  const exhibitionGrade =
    factorValue(prediction, "exhibition_grade", "exhibition_rank") ??
    (exhibitionScore === null ? "-" : scoreToGrade(exhibitionScore));
  ...
  />
      ...
      <div
        style={{
          ...
          gap: "16px",
          alignItems: "center",
          boxShadow: "0 8px 24px rgba(31, 132, 204, .10)",
        }}
      >
        <div>
          <span
          ...
          >
            ...
            >
              {exhibitionScore === null ? "-" : Math.round(exhibitionScore)}
              {exhibitionScore !== null && (
                <small style={{ fontSize: "15px" }}>点</small>
              )}
            </strong>

            <strong style={{ color: "#145d8d", fontSize: "21px" }}>
              {exhibitionGrade}判定
            </strong>
          </div>
              ...
              style={{
                ...
                background:
                  scoreDiff >= 0
                    ? "rgba(27, 150, 91, .10)"
                    : "rgba(202, 55, 55, .10)",
                color: scoreDiff >= 0 ? "#14804a" : "#bd3636",
                fontSize: "12px",
                fontWeight: 900,
              }}
            >
        ...
        <div
          ...
          style={{
            color: exhibitionStars === "-" ? "#8ca9bb" : "#168bd0",
            fontSize: "25px",
            letterSpacing: ".04em",
            whiteSpace: "nowrap",
          }}
