...
export async function fetchShimonosekiWakamatsuVerifiedOriginalTenji(race, options = {}) {
  ...
  // Both official endpoints occasionally exceed ten seconds from Vercel.
  // This adapter is limited to these two venues, so the allowance cannot delay other collectors.
  const defaultTimeoutMs = 16000;
  const maximumTimeoutMs = 18000;
