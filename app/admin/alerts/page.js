...
import DataQualityNotificationCenter from './DataQualityNotificationCenter';
...
const tools = [
 ...
 ['#data-quality','⚠️','データ欠損通知','出走表・展示・結果の未解消レースを確認'],
...
export default function AlertsPage(){
 return <main className={styles.page}><div className={styles.shell}>
  <header className={styles.hero}><span>BOATSTRIKERS / ALERT MANAGEMENT</span><h1>アラート管理</h1><p>展示データの取得確認から、データ欠損・各理論アラートの成立確認まで。</p></header>
  ...
  <Suspense fallback={<p role="status">データ欠損通知を読み込んでいます…</p>}><DataQualityNotificationCenter /></Suspense>
