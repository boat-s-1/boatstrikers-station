...
async function inspect(url) {
  ...
  try {
    ...
    return { ok: true, upstreamStatus: res.status, bytes: size, charset,
      ...
      identityMarkup: /^(https:\/\/www\.boatrace\.jp\/owpc\/pc\/race\/beforeinfo\?|http:\/\/www\.boatrace-tokuyama\.jp\/tenji-keisoku\/m\/|https:\/\/www\.boatrace-suminoe\.jp\/asp\/kyogi\/12\/sp\/|https:\/\/omurakyotei\.jp\/yosou\/m\/|https:\/\/www\.mikuniks-web\.jp\/races$)/.test(url) ? html.slice(0, 100000) : undefined,
