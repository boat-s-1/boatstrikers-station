...
export function fetchTrackedOriginalTenji(client, consumer, race, options = {}, finalize = null) {
  return trackExhibitionFetch(client, consumer, race, fetchBestOriginalTenji, options, console, finalize);
}
